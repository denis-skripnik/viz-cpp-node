...
namespace graphene {
    ...
    namespace plugins {
        void register_plugins(){
            ...
            appbase::app().register_plugin<graphene::plugins::social_network::social_network>();
            ...
            appbase::app().register_plugin<graphene::plugins::tags::tags_plugin>();
            appbase::app().register_plugin<graphene::plugins::follow::plugin>();
            #ifdef MONGODB_PLUGIN_BUILT
...
int main( int argc, char** argv ) {
    try {
        ...
        graphene::plugins::register_plugins();
        appbase::app().set_version_string(version_string());

        // Setup logging config
        boost::program_options::options_description options;
        graphene::utilities::set_logging_program_options(options);
        ...
        bool initialized = appbase::app().initialize<
                ...
                graphene::plugins::webserver::webserver_plugin
        >
                ( argc, argv );
        ...
        try {
            auto logging_config = graphene::utilities::load_logging_config(appbase::app().config_path());
            if (logging_config)
