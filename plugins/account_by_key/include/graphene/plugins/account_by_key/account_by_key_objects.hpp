...
FC_REFLECT((graphene::plugins::account_by_key::key_lookup_object), (id)(key)(account))
CHAINBASE_SET_INDEX_TYPE(graphene::plugins::account_by_key::key_lookup_object, graphene::plugins::account_by_key::key_lookup_index)
