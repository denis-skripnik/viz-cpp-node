...
namespace graphene { namespace plugins { namespace follow {
    ...
    DEFINE_API_ARGS(get_feed,                msg_pack, std::vector<content_feed_entry>)
    DEFINE_API_ARGS(get_blog_entries,        msg_pack, std::vector<blog_entry>)
    DEFINE_API_ARGS(get_blog,                msg_pack, std::vector<content_blog_entry>)
