...
namespace graphene {
    namespace protocol {
        ...
        fc::variant_object get_config() {
            ...
            result["CHAIN_GENESIS_TIME"] = CHAIN_GENESIS_TIME;
            ...
            result["CHAIN_MAX_BLOCK_SIZE"] = CHAIN_MAX_BLOCK_SIZE;
            ...
            result["CHAIN_VOTE_REGENERATION_SECONDS"] = CHAIN_VOTE_REGENERATION_SECONDS;
