...
fc::variant_object get_config()
{
   ...
   result["STEEM_VOTE_POWER_RATE"] = STEEM_VOTE_POWER_RATE;
   ...
   result["STEEM_CHAIN_ID_NAME"] = STEEM_CHAIN_ID_NAME;
   ...
   result["STEEM_FIXED_INFLATION"] = STEEM_FIXED_INFLATION;
   ...
   result["STEEM_REVERSE_AUCTION_WINDOW_SECONDS"] = STEEM_REVERSE_AUCTION_WINDOW_SECONDS;
   ...
   result["STEEM_VOTE_REGENERATION_SECONDS"] = STEEM_VOTE_REGENERATION_SECONDS;
