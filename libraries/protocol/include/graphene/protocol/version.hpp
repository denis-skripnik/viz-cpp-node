...
/*
 * This class represents the basic versioning scheme of the graphene blockchain.
...
FC_REFLECT((graphene::protocol::version), (v_num))
FC_REFLECT_DERIVED((graphene::protocol::hardfork_version), ((graphene::protocol::version)),)

FC_REFLECT((graphene::protocol::hardfork_version_vote), (hf_version)(hf_time))
