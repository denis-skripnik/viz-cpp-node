...
#define VESTS_SYMBOL  (uint64_t(6) | (uint64_t('S') << 8) | (uint64_t('H') << 16) | (uint64_t('A') << 24) | (uint64_t('R') << 32) | (uint64_t('E') << 40) | (uint64_t('S') << 48))
#define STEEM_SYMBOL  (uint64_t(3) | (uint64_t('V') << 8) | (uint64_t('I') << 16) | (uint64_t('Z') << 24))
...
#define STEEMIT_INITIATOR_PUBLIC_KEY            (graphene::protocol::public_key_type(STEEMIT_INITIATOR_PUBLIC_KEY_STR))
...
#define CONSENSUS_BANDWIDTH_RESERVE_PERCENT     (STEEMIT_100_PERCENT/10) // 10%
...
#define STEEMIT_COMMITTEE_PUBLIC_KEY            (graphene::protocol::public_key_type(STEEMIT_COMMITTEE_PUBLIC_KEY_STR))
