...
#define VESTS_SYMBOL_U64  (uint64_t('S') | (uint64_t('H') << 8) | (uint64_t('A') << 16) | (uint64_t('R') << 24) | (uint64_t('E') << 32) | (uint64_t('S') << 40))
#define STEEM_SYMBOL_U64  (uint64_t('V') | (uint64_t('I') << 8) | (uint64_t('Z') << 16))
