...
FC_REFLECT((graphene::chain::transaction_object), (id)(packed_trx)(trx_id)(expiration))
CHAINBASE_SET_INDEX_TYPE(graphene::chain::transaction_object, graphene::chain::transaction_index)
