...
FC_REFLECT((graphene::chain::block_summary_object), (id)(block_id))
CHAINBASE_SET_INDEX_TYPE(graphene::chain::block_summary_object, graphene::chain::block_summary_index)
