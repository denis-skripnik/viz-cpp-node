...
namespace graphene {
    namespace chain {
        ...
        using graphene::protocol::weight_type;
...
FC_REFLECT_TYPENAME((graphene::chain::shared_authority::account_authority_map))
FC_REFLECT((graphene::chain::shared_authority), (weight_threshold)(account_auths)(key_auths))
