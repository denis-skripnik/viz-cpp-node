...
namespace graphene {
    namespace chain {
        ...
        template<typename EvaluatorType, typename OperationType=graphene::protocol::operation>
...
class X ## _evaluator : public graphene::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : graphene::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
